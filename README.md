...
Current Interests:
I have a broad set of tech and gaming interests that often guide the kind of experiments I run in this repo:

DOS games and retro computing, especially the simplicity and hands-on feel of older systems.

Trying things out in HxD, learning how hexadecimal data shapes files and how tiny edits can change outcomes.

Building early understanding of HTML and CSS, figuring out structure, styling, and the logic that holds the web together.
